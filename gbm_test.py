...
print("train auc:", roc_auc_score(np.array(y_train), gbm.predict_proba(np.array(X_train))[:, 1]))
print("test auc:", roc_auc_score(np.array(y_test), gbm.predict_proba(np.array(X_test))[:, 1]))
